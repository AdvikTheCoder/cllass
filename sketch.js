...
function setup() {
  ...
  desert = createSprite(300,100);
  desert.addAnimation("desert")
  ...
  invisibleGround = createSprite(trex.x,190,600,10);
...
function draw() {
  ...
  camera.position.x = camera.position.x + (6 + 3*score/100);
  ...
  if (gameState === PLAY){
    ...
    restart.x = trex.x + 270;
    gameOver.x = trex.x + 270;
